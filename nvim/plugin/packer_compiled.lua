...
local package_path_str = "/root/.cache/nvim/packer_hererocks/2.1.1761727121/share/lua/5.1/?.lua;/root/.cache/nvim/packer_hererocks/2.1.1761727121/share/lua/5.1/?/init.lua;/root/.cache/nvim/packer_hererocks/2.1.1761727121/lib/luarocks/rocks-5.1/?.lua;/root/.cache/nvim/packer_hererocks/2.1.1761727121/lib/luarocks/rocks-5.1/?/init.lua"
local install_cpath_pattern = "/root/.cache/nvim/packer_hererocks/2.1.1761727121/lib/lua/5.1/?.so"
...
_G.packer_plugins = {
  ...
  ["augment.vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/augment.vim",
  ...
  ["baleia.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/baleia.nvim",
    url = "https://github.com/m00qek/baleia.nvim"
  },
  ["chafa.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/chafa.nvim",
  ...
  ["ejs-syntax"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/ejs-syntax",
  ...
  ["git-rebase-auto-diff.nvim"] = {
    config = { "\27LJ\2\nB\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\25git-rebase-auto-diff\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/git-rebase-auto-diff.nvim",
  ...
  ["lua-async-await"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/lua-async-await",
  ...
  neocord = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/neocord",
  ...
  ["neotest-java"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/neotest-java",
  ...
  ["nvim-http"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-http",
    url = "https://github.com/BlackLight/nvim-http"
  },
  ["nvim-java"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-java",
    url = "https://github.com/nvim-java/nvim-java"
  },
  ["nvim-java-core"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-java-core",
    url = "https://github.com/nvim-java/nvim-java-core"
  },
  ["nvim-java-dap"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-java-dap",
    url = "https://github.com/nvim-java/nvim-java-dap"
  },
  ["nvim-java-refactor"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-java-refactor",
    url = "https://github.com/nvim-java/nvim-java-refactor"
  },
  ["nvim-java-test"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-java-test",
  ...
  ["nvim-popcorn"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-popcorn",
    url = "https://github.com/javiorfo/nvim-popcorn"
  },
  ["nvim-pqf"] = {
    config = { "\27LJ\2\n1\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\bpqf\frequire\0" },
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-pqf",
    url = "https://github.com/yorickpeterse/nvim-pqf"
  },
  ["nvim-spinetta"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-spinetta",
    url = "https://github.com/javiorfo/nvim-spinetta"
  },
  ["nvim-springtime"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-springtime",
  ...
  ["resty.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/resty.nvim",
  ...
  ["vim-matchtag"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-matchtag",
    url = "https://github.com/leafOfTree/vim-matchtag"
  },
  ["vim-react-snippets"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-react-snippets",
...
vim.cmd [[au FileType gitrebase ++once lua require("packer.load")({'git-rebase-auto-diff.nvim'}, { ft = "gitrebase" }, _G.packer_plugins)]]
